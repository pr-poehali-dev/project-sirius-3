...
import { Settings, Plug, MessageSquare, ArrowRight } from "lucide-react"
...
const steps = [
  {
    ...
    description:
      "Откройте мастер и опишите, как должен отвечать ваш ассистент — тон, ограничения, сценарии и базу знаний. Сразу же протестируйте внутри кабинета.",
    number: "01",
  },
  {
    icon: Plug,
    ...
    description:
      "Вставьте скрипт виджета на сайт или введите токен Telegram-бота. Буквально пара минут — и ассистент уже принимает первые обращения.",
    number: "02",
  },
  {
    icon: MessageSquare,
    title: "Общайтесь в инбоксе",
    description:
      "Все диалоги из всех каналов — в одном окне. Подключайте оператора в любой момент, история не теряется. Смотрите аналитику и управляйте расходами.",
    number: "03",
  },
]
      ...
      <div className="container mx-auto max-w-7xl relative z-10">
        <div className="text-center mb-16">
          ...
          <h2 className="text-3xl sm:text-4xl md:text-5xl font-bold mb-6 text-balance">
            От <span className="text-primary">мастера</span> к <span className="text-primary">диалогу</span>
          </h2>
          <p className="text-lg text-muted-foreground max-w-3xl mx-auto text-pretty leading-relaxed">
            Мастер → канал → работа в инбоксе. Запуск за 5 минут, без разработчиков и технических знаний.
          </p>
        </div>
